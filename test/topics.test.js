...
describe("AWS SNS Topics Service", () => {
  beforeAll(() => {
    AWS.mock("SNS", "listTopics", {
      ...
      Topics: [{ TopicArn: "arn:aws:sns:us-east-1:658710424301:MySNSTopic" }],
    });
    ...
    AWS.mock("SNS", "deleteTopic", {
      ResponseMetadata: { RequestId: "95430101-9554-5d24-9abf-54b913bc3d8c" },
    });
    ...
    AWS.mock("SNS", "setTopicAttributes", {
      ResponseMetadata: { RequestId: "807fddda-5864-5a19-872c-8862d28696a7" },
    });
  ...
  test("deletes a topic and all its subscriptions", async () => {
    const result = await app
      .service("sns/topics")
      .remove({ TopicArn: "arn:aws:sns:us-east-1:658710424301:MyTopic" });
    expect(result).toStrictEqual({
      ResponseMetadata: { RequestId: "95430101-9554-5d24-9abf-54b913bc3d8c" },
    });
  });
